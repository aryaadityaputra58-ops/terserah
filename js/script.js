...
function renderHeader(activePage) {
  ...
  header.innerHTML = `
    <nav class="nav">
      <div class="nav-inner">
        <a href="index.html" class="brand"><span class="brand-mark"></span> Hammers Wallabe</a>
        ...
        <div class="nav-search">
          ...
          <input type="search" id="global-search" placeholder="Cari sepatu, kota, warna..." aria-label="Cari produk">
        </div>
  ...
  footer.innerHTML = `
    <div class="container footer-grid">
      <div class="footer-brand">
        <a href="index.html" class="brand" style="color:#EDE7D8"><span class="brand-mark"></span> Hammers Wallabe</a>
        <p>Toko sepatu city-series suede untuk pecinta sneaker jalanan — otentik, bergaya, dan siap dipakai keliling kota.</p>
      ...
      <div>
        <h4>Drop Terbaru</h4>
        <p style="color:#C9C2AD;font-size:.88rem">Dapatkan info restock & colorway baru lebih dulu.</p>
    ...
    <div class="container footer-bottom">
      <span>&copy; ${new Date().getFullYear()} Hammers Wallabe. Semua hak dilindungi.</span>
      <span>Dibuat untuk pecinta sneaker city-series 👟</span>
    </div>`;
  ...
  const io = new IntersectionObserver((entries) => {
    entries.forEach(entry => {
      if (entry.isIntersecting) {
        entry.target.style.animation = "hw-fade-up .5s ease both";
...
style.textContent = `@keyframes hw-fade-up{from{opacity:0;transform:translateY(14px)}to{opacity:1;transform:translateY(0)}}`;
