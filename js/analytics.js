/* ============================================================
   Hammers Wallabe — Integrasi Analytics (DUMMY)
   ------------------------------------------------------------
   ...
   6. Sumber trafik & kata kunci pencarian internal — event
                            "search" membantu memahami model/kota
                            sepatu yang paling dicari pengunjung.
   7. Engagement per kategori — event "select_category" &
                            "filter_applied" menunjukkan silhouette
                            (Terrace/Spezial/Runner) paling diminati
                            untuk prioritas restock.
   ============================================================ */
