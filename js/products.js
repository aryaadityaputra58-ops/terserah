        ...
        <div class="modal-grid">
          ...
          <div class="modal-info">
            ...
            <div class="qty-row">
              ...
              <span class="muted" style="font-size:.85rem">Maks. ${p.stock} pasang</span>
            </div>
...
function initCatalogPage() {
  ...
  function applyFilters() {
    ...
    resultCount.textContent = `${list.length} sepatu ditemukan`;
    grid.innerHTML = list.length
      ? list.map(renderProductCard).join("")
      : `<div class="empty-state"><h3>Tidak ada sepatu cocok</h3><p>Coba ubah kata kunci atau filter Anda.</p></div>`;
